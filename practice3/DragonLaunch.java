//Код адамдарды топқа қосады, BOY-GIRL жұптарын жұптастырады,
//Қалған адамдардың бар-жоғын тексеріп, драконның “жейтінін” немесе “қалмайтынын” шығарады.
//Мәтіндік жолдан топ жасауға болады (fromString).
